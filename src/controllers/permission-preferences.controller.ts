...
export class PermissionPreferencesController {
  ...
  @response(200, {
    ...
    content: {'application/json': {schema: getModelSchemaRef(PermissionPreferences)}},
  })
  async create(
    @requestBody({
      content: {
    ...
    permissionPreferences: Omit<PermissionPreferences, 'permissionPreferenceId'>,
  ...
  @response(200, {
    ...
    content: {
      'application/json': {
        schema: {
          type: 'array',
          items: getModelSchemaRef(PermissionPreferences, {includeRelations: true}),
        },
      },
    },
  })
  ...
  async updateAll(
    ...
    return this.permissionPreferencesRepository.updateAll(permissionPreferences, where);
  }
  ...
  @response(200, {
    ...
    content: {
      'application/json': {
        schema: getModelSchemaRef(PermissionPreferences, {includeRelations: true}),
      },
    },
  })
  async findById(
    @param.path.string('id') id: string,
    @param.filter(PermissionPreferences, {exclude: 'where'}) filter?: FilterExcludingWhere<PermissionPreferences>
  ): Promise<PermissionPreferences> {
  ...
  async updateById(
    ...
    await this.permissionPreferencesRepository.updateById(id, permissionPreferences);
  }
  ...
  async replaceById(
    ...
    await this.permissionPreferencesRepository.replaceById(id, permissionPreferences);
  }
